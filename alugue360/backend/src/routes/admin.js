...
router.get("/dashboard", async (req, res) => {
  try {
    const [users, listings, categories, plans, subscriptions, rentals] = await Promise.all([
      prisma.user.count(),
    ...
    res.json({ stats: { totalUsers: users, totalListings: listings, totalCategories: categories, totalPlans: plans, totalSubscriptions: subscriptions, activeSubscriptions: rentals }, recentUsers, recentListings });
  } catch (err) {
